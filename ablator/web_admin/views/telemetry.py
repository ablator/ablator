...
def create_source_type_chart(signals):
    source_version_count = {"isTestFlight": 0, "isAppStore": 0, "isSimulator": 0}
    for signal in signals:
...
class SignalListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["charts"] = [
            {
                "App Version": DonutChart(
                    accumulated_dictionary_data_source(distinct_last_month_signals, "appVersion"), height=dim, width=dim
                ),
                "System Version": DonutChart(
                    accumulated_dictionary_data_source(distinct_last_month_signals, "systemVersion"), height=dim, width=dim
                ),
                "Build Number": DonutChart(
                    accumulated_dictionary_data_source(distinct_last_month_signals, "buildNumber"), height=dim, width=dim
                ),
            ...
            },
            {
                ...
                "Should Use HealthKit": DonutChart(
                    accumulated_dictionary_data_source(distinct_last_month_signals, "shouldUseHealthKit"), height=dim, width=dim
                ),
            },
        ]
